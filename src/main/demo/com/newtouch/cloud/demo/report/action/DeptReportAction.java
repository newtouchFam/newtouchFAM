...
import com.newtouch.cloud.demo.report.bp.DeptReportBP;

@Controller
@Scope(ConfigurableBeanFactory.SCOPE_PROTOTYPE)
@RequestMapping("/demo/report/deptreport")
public class DeptReportAction extends JRClassicBaseAction
{
	@Autowired
	private DeptReportBP bp;

...
<HTML>
	<HEAD>
		...
		<script type="text/javascript" src="wfs/gl/vouchermanager/voucherquery/voucherquerycondition.js"></script>
		<script type="text/javascript" src="wfs/gl/vouchermanager/voucherquery/voucherquerydetail.js"></script>
		<script type="text/javascript" src="wfs/gl/vouchermanager/vouchermake/voucherprint.js"></script>
		<script type="text/javascript" src="wfs/gl/vouchermanager/voucherquery/voucherquery.js"></script>
	</HEAD>
<body>
	<div id='maindiv'>
	</div>

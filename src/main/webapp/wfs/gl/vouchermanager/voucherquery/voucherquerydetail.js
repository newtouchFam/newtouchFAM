...
gl.vouchermanager.voucherquery.voucherquerydetail = Ext.extend(Ext.grid.GridPanel,
{
	region : "center",
	//列是否能移动
	...
	initComponent : function ()
	{
		...
		{	
			totalProperty : "total",
			root : "data",
			url : 'vouchermanager/vouchermain/queryinfo',
			fields : record
		});
		...
		gl.vouchermanager.voucherquery.voucherquerydetail.superclass.initComponent.call(this);
	}
});
...
<HTML>
	<HEAD>
		...
		<script type="text/javascript" src="wfs/gl/vouchermanager/voucherend/voucherendcondition.js"></script>
		<script type="text/javascript" src="wfs/gl/vouchermanager/voucherend/voucherenddetail.js"></script>
		<script type="text/javascript" src="wfs/gl/vouchermanager/vouchermake/voucherprint.js"></script>
		<script type="text/javascript" src="wfs/gl/vouchermanager/voucherend/voucherend.js"></script>
	</HEAD>
	<body>
		<div id='maindiv'>
		</div>

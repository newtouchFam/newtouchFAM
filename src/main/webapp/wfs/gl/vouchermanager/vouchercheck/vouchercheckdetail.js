...
gl.vouchermanager.vouchercheck.vouchercheckdetail = Ext.extend(Ext.grid.GridPanel,
{
	region : "center",
	//列是否能移动
	...
	initComponent : function ()
	{
		...
		[
		    ...
		    dtcasher, uqcasherid,dtaccountant, uqaccountantid, intstatus
	    ]);
		...
		{	
			totalProperty : "total",
			root : "data",
			url : 'vouchermanager/vouchermain/checkinfo',
			fields : record
		});
		...
		gl.vouchermanager.vouchercheck.vouchercheckdetail.superclass.initComponent.call(this);
	}
});
...
gl.vouchermanager.vouchercash.vouchercashdetail = Ext.extend(Ext.grid.GridPanel,
{
	region : "center",
	//列是否能移动
	...
	initComponent : function ()
	{
		...
		{	
			totalProperty : "total",
			root : "data",
			url : 'vouchermanager/vouchermain/cashinfo',
			fields : record
		});
		...
		gl.vouchermanager.vouchercash.vouchercashdetail.superclass.initComponent.call(this);
	}
});
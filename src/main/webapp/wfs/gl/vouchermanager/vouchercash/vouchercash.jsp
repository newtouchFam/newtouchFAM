...
<HTML>
	<HEAD>
		...
		<script type="text/javascript" src="wfs/gl/vouchermanager/vouchercash/vouchercashcondition.js"></script>
		<script type="text/javascript" src="wfs/gl/vouchermanager/vouchercash/vouchercashdetail.js"></script>
		<script type="text/javascript" src="wfs/gl/vouchermanager/vouchermake/voucherprint.js"></script>
		<script type="text/javascript" src="wfs/gl/vouchermanager/vouchercash/vouchercash.js"></script>
</HEAD>
	<body>
		<div id='maindiv'>
		</div>

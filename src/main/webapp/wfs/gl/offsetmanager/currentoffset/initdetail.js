 ...
 * 查看初始化明细窗口
 */
gl.offsetmanager.currentoffset.initdetail = Ext.extend(Ext.grid.EditorGridPanel,
    {
        id : 'gl.offsetmanager.currentoffset.initdetail',
        autoHeight : true,
        region : 'center',
        //列是否能移动
        ...
        {
            this.createControl();
            gl.offsetmanager.currentoffset.initdetail.superclass.initComponent.call(this);

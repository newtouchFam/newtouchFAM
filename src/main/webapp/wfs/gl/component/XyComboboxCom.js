...
Ext.app.XyComboBoxCom = Ext.extend(Ext.form.ComboBox, {
		typeAhead : true,
		winHeight : 300,
		call : Ext.emptyFn,
		selectOnFocus : true,
		...
		Ext.app.XyComboBoxCom.superclass.initComponent.call(this);
...
//				+ this.valueField + '})</div></tpl>';
	...
	getOtherValue : function() {
		if (this.hiddenData != null && this.hiddenData[this.othervalue] != null) {
			return this.hiddenData[this.othervalue];
		}
		return "";
	},
	getHiddenData : function() {
		//var hiddendata = Ext.getCmp("xxx").getHiddenData(); var year = hiddendata["column4"];
		if (this.hiddenData != null) {
...
Ext.reg("xycomboboxcom", Ext.app.XyComboBoxCom);

...
gl.component.basetreegridselect = Ext.extend(gl.component.basegridselect,
{
    width : 750,
    height : 450,
    ...
    getTree : function()
    {
        if (!this.tree)
        {
            ...
            this.tree.on("click", onClickExpand, this);
            root.expand();
        }
        return this.tree;
    },
    ...
    initComponent : function()
    {
        ...
        gl.component.basetreegridselect.superclass.initComponent.call(this);
    ...
    {
    	this.getGridStore().baseParams.node = node.attributes.name;
    	this.getGridStore().baseParams.codecondition = this.codecondition;
        this.loadData();
    }
});
 ...
 */
Ext.PagingToolbarEx = Ext.extend(Ext.Toolbar, {
    /**
    ...
    initComponent : function(){
        Ext.PagingToolbarEx.superclass.initComponent.call(this);
        this.cursor = 0;
//        this.bind(this.store);
    ...
    onRender : function(ct, position){
        Ext.PagingToolbarEx.superclass.onRender.call(this, ct, position);
    ...
    updateInfo : function(){
        if(this.displayEl){
            ...
            var msg = count == 0 ?
                ...
                String.format(
                    this.displayMsg,
                    this.cursor+1,this.totalCount<(this.cursor+this.pageSize)?this.totalCount:(this.cursor+this.pageSize),this.totalCount
                );
	...
	doLoad : function(start){
        this.load.call(this.scope,false,start,(this.totalCount<(start+this.pageSize))?this.totalCount:(start+this.pageSize));
        this.onLoad(start);
    },
    // private
...
if(Ext.PagingToolbarEx){
   Ext.apply(Ext.PagingToolbarEx.prototype, {
	  displayInfo: true,

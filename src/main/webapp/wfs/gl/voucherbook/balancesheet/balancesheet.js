Ext.namespace("gl.voucherbook.balancesheet");

gl.voucherbook.balancesheet.QueryFormPanel = Ext.extend(Ext.FormPanel, 
{
	frame : true,
	labelWidth : 100,
	labelAlign : "right",
	...
	initComponent : function() 
	{
    	...
    	gl.voucherbook.balancesheet.QueryFormPanel.superclass.initComponent.call(this);
	...
	{	
		...
		this.xy_MainPanel.QueryEvent.call(this.xy_MainPanel,
		{
			 ...
			 */
			jasper : "/wfs/gl/voucherbook/balancesheet/balancesheet_look.jasper",
			/**
			 * (导出)报表jasper文件路径(非url)，从webapp/webRoot目录算起
			 */
			jasper_export : "/wfs/gl/voucherbook/balancesheet/balancesheet.jasper",
			/**
			 * 报表标题，必填
			 */
			title : "资产负债表",
...
function init() {
	...
	{
		xy_QueryPanel : gl.voucherbook.balancesheet.QueryFormPanel,

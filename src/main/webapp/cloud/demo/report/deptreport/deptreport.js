Ext.namespace("demo.report.DeptReport");

demo.report.DeptReport.ConditionWin = Ext.extend(Ext.FormPanel,
{
	frame : true,
	labelAlign : "right",
	labelWidth : 100,
	initComponent : function()
	{
		...
		demo.report.DeptReport.ConditionWin.superclass.initComponent.call(this);
	},
	query : function()
	{
		...
		this.xy_MainPanel.QueryEvent.call(this.xy_MainPanel,
		{
			 ...
			 */
			jasper : "/demo/report/deptreport/deptreport.jasper",
			/**
			 * 报表标题，必填
			 */
			title : "部门用户统计(非分页)",
...
function init()
{
	...
	{
		xy_QueryPanel : demo.report.DeptReport.ConditionWin,

Ext.namespace('Freesky.grid');
Ext.grid.XyGridPanel = Ext.extend(Ext.Panel, {
	...
	initComponent : function() {
		Ext.grid.XyGridPanel.superclass.initComponent.call(this);
	...
	onRender : function(C, A) {
		Ext.grid.XyGridPanel.superclass.onRender.apply(this, arguments);
		var D = this.body;
	...
	initEvents : function() {
		Ext.grid.XyGridPanel.superclass.initEvents.call(this);
		if (this.loadMask) {
	...
	initStateEvents : function() {
		Ext.grid.XyGridPanel.superclass.initStateEvents.call(this);
	...
	afterRender : function() {
		Ext.grid.XyGridPanel.superclass.afterRender.call(this);
		this.view.layout();
		this.viewReady = true
	},
	...
	onDestroy : function() {
		...
		Ext.grid.XyGridPanel.superclass.onDestroy.call(this)
	},
	...
	onResize : function() {
		Ext.grid.XyGridPanel.superclass.onResize.apply(this, arguments);
		if (this.viewReady) {
			this.view.layout()
		}
	},
	...
	getView : function() {
		if (!this.view) {
			this.view = new Ext.grid.XyGridView(this.viewConfig)
		}
		return this.view
	},
...
Ext.reg("xygridpanel", Ext.grid.GridPanel);

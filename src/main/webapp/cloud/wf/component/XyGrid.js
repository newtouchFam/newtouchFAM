...
Ext.app.XyGrid = Ext.extend(Ext.form.TwinTriggerField, {
	call : Ext.emptyFn,
	initComponent : function() {
		Ext.app.XyGrid.superclass.initComponent.call(this);
	...
	getDisplayValue : function() {
		if (this.hiddenData != null
				&& this.hiddenData[this.displayField] != null) {
	...
	onTrigger1Click : function() {
		...
		this.m_loader = new Ext.data.JsonStore({
					url : url,
					root : 'data',
		...
		var m_btnSearch = new Ext.app.SearchField({
			...
			onTrigger1Click : function() {
				...
				m_this.m_loader.baseParams.totalCount = m_this.m_loader.getTotalCount();
				if (m_this.param != null) {
					for (var i = 0; i < m_this.param.length; i++) {

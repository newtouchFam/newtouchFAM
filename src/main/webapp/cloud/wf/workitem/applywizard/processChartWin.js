...
freesky.ssc.wfmgr.processinstMgr.processChartWin = Ext.extend(top.Ext.Window,
{
	title : "流程图",
	width : 480,
	height : 480,
	...
	loadImg: function()
	{
		var img = top.Ext.getDom("xy.ssc.wfmgr.processchartimg");
		if (img)
		{
			var url = "";
			...
			top.Ext.get("xy.ssc.wfmgr.processchartimg").on("load", function(){if(loadMask){loadMask.hide(); loadMask = null;} });

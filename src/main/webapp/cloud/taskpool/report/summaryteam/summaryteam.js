...
ssc.taskpool.report.SummaryTeam.QueryFormPanel = Ext.extend(Ext.FormPanel,
{
	frame : true,
	labelAlign : "right",
	labelWidth : 100,
	...
	initComponent : function()
	{
		...
		ssc.taskpool.report.SummaryTeam.QueryFormPanel.superclass.initComponent.call(this);
	},
	query : function()
	{
		...
		{
			jasper : "summaryteam.jasper",
			subdir : "SSC/core/taskpool/report/summaryteam/",
			subreportjasper : "SSC/core/taskpool/report/summaryteam/summaryteam_sub.jasper",
			exvtreporturl : "SSC/core/taskpool/report/summaryteam/summaryteam_exvt.jsp",
			title : "任务组工作量统计表",
			fileName : "summaryteam",
			basePath : Ext.get("basePath").dom.value,
			jsonCondition : Ext.encode(param)
		}, "SSC/ssc_SummaryTeamAction$report.action");
	}
});
...
function init()
{
	...
	{
		xy_QueryPanel : ssc.taskpool.report.SummaryTeam.QueryFormPanel,

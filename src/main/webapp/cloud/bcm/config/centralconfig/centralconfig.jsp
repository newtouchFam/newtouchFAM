...
<script type="text/javascript" src="BCM/common/com.freesky.ssc.bcm.common.IndexTree.js"></script>
...
<script type="text/javascript" src="cloud/bcm/config/centralconfig/centralconfig.js"></script>
<title></title>
</head>

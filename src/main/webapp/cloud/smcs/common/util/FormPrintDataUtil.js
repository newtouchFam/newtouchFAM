 ...
 * 表单打印数据获取工具类
 */
ssc.smcs.common.FormPrintDataUtil = {};

/**
 * 读取表单默认的打印数据
 * param: 标准打印数据
 */
ssc.smcs.common.FormPrintDataUtil.getHeadPrintData = function(/**/entityControls1,
/**/entityControls2)
{
	var jsonObject = {};

	jsonObject = ssc.smcs.common.FormPrintDataUtil.getPrintDataFromEntityControls(jsonObject, entityControls1);

	jsonObject = ssc.smcs.common.FormPrintDataUtil.getPrintDataFromEntityControls(jsonObject, entityControls2);
 ...
 * param: 标准打印数据
 */
ssc.smcs.common.FormPrintDataUtil.getPrintDataFromEntityControls = function(/* Object */jsonPrintData, /* Array */
																			entityControls)
{

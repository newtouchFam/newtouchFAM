 ...
 * 表单访问控制属性设置工具类
 */
ssc.core.common.FormAccessUtil = {};

FormAccessUtil = ssc.core.common.FormAccessUtil;
 ...
 */
ssc.core.common.FormAccessUtil.setFormAccess = function(/* jsonString */ accessConfig, /* String */ tag, /* array<string> */ arrayGridPanelID)
{
	var config = new ssc.core.common.FormAccessConfig(accessConfig, tag);
	...
	for (var i = 0; i < config.getFieldIDList().length; i++)
	{
		...
		ssc.core.common.FormAccessUtil.setFieldAccess(strFieldID, strFieldAccessProperty);
	}
	...
	for (var i = 0; i < config.getGridPanelIDList().length; i++)
	{
		...
		ssc.core.common.FormAccessUtil.setGridAccess(config, strGridPanelID);
	}
};
 ...
 */
ssc.core.common.FormAccessUtil.setFieldAccess = function(strFieldID, strFieldAccessProperty)
{
	...
	if (strFieldAccessProperty == ssc.core.common.AccessPropertyEnum.Editable)
	{
		ssc.core.common.FormAccessUtil.setFieldEditable(field, true);
/*		field.disabled = false;*/
	}
	else if (strFieldAccessProperty == ssc.core.common.AccessPropertyEnum.ReadOnly)
	{
		ssc.core.common.FormAccessUtil.setFieldEditable(field, false);
/*		field.disabled = true;*/	
	}
	else if (strFieldAccessProperty == ssc.core.common.AccessPropertyEnum.Hidden)
	{
		ssc.core.common.FormAccessUtil.setFieldHidden(field, true);
...
ssc.core.common.FormAccessUtil.setFieldEditable = function(field, blEditable)
{
/*	if (field.rendered)
	{
		if (blEditable)
...
ssc.core.common.FormAccessUtil.setFieldHidden = function(field, blHidden)
{
	if (field.rendered)
	{
		if (field.isDerive("textfield"))
...
ssc.core.common.FormAccessUtil.setFieldHiddenEx = function(field, blHidden)
{
	if (blHidden)
	{
 ...
 * strGridPanelID	表格ID
 */
ssc.core.common.FormAccessUtil.setGridAccess = function(config, strGridPanelID)
{
...
/*
	...
	for (var i = 0; i < config.getColumnDataIndexList(strGridPanelID).length; i++)
	{
		...
		ssc.core.common.FormAccessUtil.setColumnAccess(gridPanel, strColumnDataIndex, strColumnAccessProperty);
	}
};
 ...
 */
ssc.core.common.FormAccessUtil.setColumnAccess = function(gridPanel, strDataIndex, strColunnAccessProperty)
{
	...
	if (strColunnAccessProperty == ssc.core.common.AccessPropertyEnum.Editable)
	{
		ssc.core.common.FormAccessUtil.setColumnEditable(columnModel, strDataIndex, true);
	}
	else if (strColunnAccessProperty == ssc.core.common.AccessPropertyEnum.ReadOnly)
	{
		/* readonly 要保证显示 */
		columnModel.setHidden(intColumnIndex, false);

		ssc.core.common.FormAccessUtil.setColumnEditable(columnModel, strDataIndex, false);
	}
	else if (strColunnAccessProperty == ssc.core.common.AccessPropertyEnum.Hidden)
	{
 ...
 * blEditable		可否编辑
 */
ssc.core.common.FormAccessUtil.setColumnEditable = function(columnModel, strDataIndex, blEditable)
{
	var intColumnIndex = columnModel.getColumnIndexByDataIndex(strDataIndex);
 ...
 * blHidden			可否隐藏
 */
ssc.core.common.FormAccessUtil.setColumnHidden = function(columnModel, strDataIndex, blHidden)
{
	var intColumnIndex = columnModel.getColumnIndexByDataIndex(strDataIndex);
 ...
 */
ssc.core.common.FormAccessUtil.disableFormByOperType = function(panelBase, panelBaseEx, arraySubGridPanel)
{
};
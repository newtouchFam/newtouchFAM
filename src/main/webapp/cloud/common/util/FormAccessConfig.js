...
/* 访问控制参数配置Demo */
ssc.core.common.DemoAccessConfig =
{
 ...
 * 访问控制配置属性枚举
 */
ssc.core.common.AccessPropertyEnum = {};
/* 显示并允许编辑 */
ssc.core.common.AccessPropertyEnum.Editable = "editable";
/* 显示但只读 */
ssc.core.common.AccessPropertyEnum.ReadOnly = "readonly";
/* 隐藏(不允许编辑) */
ssc.core.common.AccessPropertyEnum.Hidden = "hidden";
/* 忽略不做处理 */
ssc.core.common.AccessPropertyEnum.None = "none";
 ...
 * tag			当前环节标签
 */
ssc.core.common.FormAccessConfig = function(accessConfig, tag)
{
...
/*	if (this._tagIndex < 0)
	...
	this.getFieldAccessProperty = function(strFieldID)
	{
		...
		if (this._tagIndex > field.length - 1)
		{
			...
			return ssc.core.common.AccessPropertyEnum.None;
		}

		var accessProperty = field[this._tagIndex];

		if (accessProperty != ssc.core.common.AccessPropertyEnum.Editable
				&& accessProperty != ssc.core.common.AccessPropertyEnum.ReadOnly
				&& accessProperty != ssc.core.common.AccessPropertyEnum.Hidden
				&& accessProperty != ssc.core.common.AccessPropertyEnum.None)
		{
			/* 断言 */

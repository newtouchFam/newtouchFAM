...
/* 组件属性配置Demo */
ssc.core.common.DemoFieldAttrConfig =
{
	field :
	{
 ...
 * 组件文本对齐属性枚举
 */
ssc.core.common.FieldAlignEnum = {};
ssc.core.common.FieldAlignEnum.Left = "left";
ssc.core.common.FieldAlignEnum.Center = "center";
ssc.core.common.FieldAlignEnum.Right = "right";
/*不做处理*/
ssc.core.common.FieldAlignEnum.None = "none";

/**
 * 组件字段类型枚举
 */
ssc.core.common.FieldTypeEnum = {};
ssc.core.common.FieldTypeEnum.Text = "text";
ssc.core.common.FieldTypeEnum.Date = "date";
ssc.core.common.FieldTypeEnum.Time = "time";
ssc.core.common.FieldTypeEnum.Integer = "integer";
ssc.core.common.FieldTypeEnum.Float = "float";
ssc.core.common.FieldTypeEnum.Money = "money";
ssc.core.common.FieldTypeEnum.Percent = "percent";
/*不做处理*/
ssc.core.common.FieldTypeEnum.None = "none";

/**
 * 汇总类型枚举
 */
ssc.core.common.SummaryTypeEnum = {};
ssc.core.common.SummaryTypeEnum.Sum = "sum";
ssc.core.common.SummaryTypeEnum.Count = "count";
ssc.core.common.SummaryTypeEnum.Max = "max";
ssc.core.common.SummaryTypeEnum.Min = "min";
ssc.core.common.SummaryTypeEnum.Average = "average";
/*不汇总*/
ssc.core.common.SummaryTypeEnum.None = "none";

/**
 * 字段组件配置属性参数对象
 */
ssc.core.common.FormFieldAttrParam = function()
{
	this.label = "none";
	this.key = "";
	this.align = "left";
 ...
 * 表格列配置属性参数对象
 */
ssc.core.common.FormColumnAttrParam = function()
{
	this.label = "none";
	this.key = "";
	this.align = "left";
 ...
 */
ssc.core.common.FormFieldAttrConfig = function(fieldAttrConfig)
{
	...
	{
		var fieldAttrParam = new ssc.core.common.FormFieldAttrParam();
	...
	this.getFieldAlign = function(strFieldID)
	{
		...
		if (strAlignAttr != ssc.core.common.FieldAlignEnum.Left
				&& strAlignAttr != ssc.core.common.FieldAlignEnum.Center
				&& strAlignAttr != ssc.core.common.FieldAlignEnum.Right
				&& strAlignAttr != ssc.core.common.FieldAlignEnum.None)
		{
			/* 断言 */
			...
			strAlignAttr = ssc.core.common.AccessPropertyEnum.None;
		}
	...
	this.getFieldType = function(strFieldID)
	{
		...
		if (strFieldTypeAttr != ssc.core.common.FieldTypeEnum.Text
				&& strFieldTypeAttr != ssc.core.common.FieldTypeEnum.Date
				&& strFieldTypeAttr != ssc.core.common.FieldTypeEnum.Time
				&& strFieldTypeAttr != ssc.core.common.FieldTypeEnum.Integer
				&& strFieldTypeAttr != ssc.core.common.FieldTypeEnum.Float
				&& strFieldTypeAttr != ssc.core.common.FieldTypeEnum.Money
				&& strFieldTypeAttr != ssc.core.common.FieldTypeEnum.Percent
				&& strFieldTypeAttr != ssc.core.common.FieldTypeEnum.None )
		{
			/* 断言 */
			...
			strFieldTypeAttr = ssc.core.common.AccessPropertyEnum.None;
		}
	...
	{
		var columnAttrParam = new ssc.core.common.FormColumnAttrParam();
		if (this._config.gridlist == undefined)
		{
		...
		{
			var grid = this._config.gridlist[i];
			columnAttrParam = new ssc.core.common.FormColumnAttrParam();
	...
	this.getColumnSumType = function(strGridPanelID, strColumnDataIndex)
	{
		...
		if (strFieldSumTypeAttr == ssc.core.common.SummaryTypeEnum.Count
				|| strFieldSumTypeAttr == ssc.core.common.SummaryTypeEnum.Max
				|| strFieldSumTypeAttr == ssc.core.common.SummaryTypeEnum.Min
				|| strFieldSumTypeAttr == ssc.core.common.SummaryTypeEnum.Average)
		{
			/* 断言 */
			...
			strFieldSumTypeAttr = ssc.core.common.SummaryTypeEnum.None;
		}

		if (strFieldSumTypeAttr != ssc.core.common.SummaryTypeEnum.Sum
				&& strFieldSumTypeAttr != ssc.core.common.SummaryTypeEnum.None )
		{
			/* 断言 */
			DebugAssertUtil.alert("FormFieldAttrConfig, 表格[" + strGridPanelID + "]中列[" + strColumnDataIndex + "]的[sumtype]参数不正确：配置值[" + strFieldSumTypeAttr + "]不允许，count、max、min、average暂时不支持，只允许sum、none");

			strFieldSumTypeAttr = ssc.core.common.AccessPropertyEnum.None;
		}
	...
	this.getColumnSumField = function(strGridPanelID, strColumnDataIndex)
	{
		...
		if (strFieldSumTypeAttr == ssc.core.common.SummaryTypeEnum.None
	...
	this.getColumnExpression = function(strGridPanelID, strColumnDataIndex)
	{
		...
		var expression = new ssc.core.common.Expression(strFieldExpression);

...
public class JZLJCellCalculator implements INSRCellCalculator
{
	/**
	 * 单科目取数
			...
			String accountCode, int direct, Map<String, Object> attachParam)
	{
		...
		//处理会计期年月
		String strYearMonth = "";
		String strStartYearMonth = year +"01";
...
//			strYearMonth = year + month + "";
        ...
        strSql += "     FROM tgl_period_accounts_notjz tpa ";

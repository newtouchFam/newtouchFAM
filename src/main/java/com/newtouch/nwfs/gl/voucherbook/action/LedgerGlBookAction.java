...
import com.newtouch.nwfs.gl.voucherbook.bp.LedgerGlBookBP;

@Controller
@Scope(ConfigurableBeanFactory.SCOPE_PROTOTYPE)
@RequestMapping("/voucherbook/laglbook")
public class LedgerGlBookAction extends JRClassicBaseAction
{
	
	@Autowired
	private LedgerGlBookBP bp;

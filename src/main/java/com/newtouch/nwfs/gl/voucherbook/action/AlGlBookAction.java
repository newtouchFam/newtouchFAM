...
import com.newtouch.nwfs.gl.voucherbook.bp.AlGlBookBP;

@Controller
@Scope(ConfigurableBeanFactory.SCOPE_PROTOTYPE)
@RequestMapping("/voucherbook/alglbook")
public class AlGlBookAction extends JRClassicBaseAction
{
	
	@Autowired
	private AlGlBookBP bp;

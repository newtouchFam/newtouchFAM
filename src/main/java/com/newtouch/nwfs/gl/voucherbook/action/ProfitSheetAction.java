...
import com.newtouch.nwfs.gl.voucherbook.bp.ProfitSheetBP;
...
@RequestMapping("/voucherbook/profitsheet")
public class ProfitSheetAction extends JRClassicBaseAction
{
	@Autowired
	private ProfitSheetBP bp;
/*
	@Override
